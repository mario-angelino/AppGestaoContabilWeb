...
import { gerarBP, type DFParams } from '../../lib/gerarDFpdf'
...
export default function BP() {
  ...
  const handleGenerate = async (params: DFParams) => {
    ...
    try {
      ...
      if (params.periodo1) {
        ...
        await gerarBP(params, df2, df1)
      } else {
        await gerarBP(params, df1)
      }
    } finally {
      setGenerating(false)
    }
  ...
  return <DFWizard title="BP — Balanço Patrimonial" generating={generating} onGenerate={handleGenerate} />
}
