...
import { type DFParams, type PeriodoDF } from '../../lib/dfData'
...
interface NotaFiltroProps {
  onChange: (params: DFParams | null) => void
}

export default function NotaFiltro({ onChange }: NotaFiltroProps) {
